...
hidden if the `scopeX_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `scopeX_DEVELOPER_MODE` to the configure
...
Runs the executable target `scopeX_exe`.
